    ...
    <div className="space-y-24 pt-8">
      ...
      <div className="relative rounded-lg overflow-hidden h-[60vh] flex items-center justify-center text-center p-6 bg-cover bg-center" style={{ backgroundImage: `url('https://picsum.photos/id/1015/1920/1080')` }}>
        ...
        <div className="relative z-10 text-white">
          ...
          <Link to="/category/clothing" className="mt-8 inline-block bg-primary text-white font-bold py-3 px-8 rounded-md hover:bg-primary-dark transition-colors duration-300">
      ...
      {/* Categories Section */}
      <div className="text-center">
        <h2 className="text-3xl sm:text-4xl font-serif font-bold">Shop Our Collections</h2>
        <p className="mt-2 text-lg text-text-secondary">Find the perfect outfit and accessories for any occasion.</p>
        <div className="mt-8 space-y-8">
          <Link to="/category/clothing" className="group relative block rounded-lg overflow-hidden h-96">
             <img src="https://picsum.photos/id/103/1200/800" alt="Clothing collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
             <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                <h3 className="text-white text-4xl font-serif font-bold">Clothing Collection</h3>
             </div>
          </Link>
        
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              <Link to="/category/fragrance" className="group relative block rounded-lg overflow-hidden h-64">
                  <img src="https://picsum.photos/id/111/800/600" alt="Fragrance collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center p-4">
                      <h3 className="text-white text-3xl font-serif font-bold text-center">Fragrance</h3>
                  </div>
              </Link>
              <Link to="/category/jewelry" className="group relative block rounded-lg overflow-hidden h-64">
                  <img src="https://picsum.photos/id/122/800/600" alt="Jewelry collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center p-4">
                      <h3 className="text-white text-3xl font-serif font-bold text-center">Jewelry</h3>
                  </div>
              </Link>
              <Link to="/category/accessories" className="group relative block rounded-lg overflow-hidden h-64">
                  <img src="https://picsum.photos/id/145/800/600" alt="Accessories collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center p-4">
                      <h3 className="text-white text-3xl font-serif font-bold text-center">Accessories</h3>
                  </div>
              </Link>
          </div>
        </div>
